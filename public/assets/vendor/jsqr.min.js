 ...
 * Copyright (c) 2016 Cosmo Wolfe / Licensed under the Apache License 2.0
 * ライセンス全文は同じディレクトリの jsqr-LICENSE.txt を参照。
 * 取得元: https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.min.js
 * 改変点: 末尾の sourceMappingURL 行のみ削除（ソースマップを同梱しないため）。
 */
/**
